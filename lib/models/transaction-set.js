...
TransactionSet.prototype.updateAttributes = function (callback) {
  async.each(this.transactions, function (transaction, callback) {
    ...
    updateInOutputs(transaction, function (err, details) {
      ...
      //TODO: better handle coynverter updating and base values storing
      coynverter.update(function() {
        var date = new Date(this.date);
        async.map(['EUR', 'USD'], function (currency, callback) {
          ...
          log.info({baseVolume: baseVolume, representation: transaction.representation}, 'Representation');
