...
Wallet.prototype.setWalletToUpdated = function (err, result, callback) {
  mongo.db.collection('bitcoinwallets').update({_id : this._id}, {$set : {updating: false}}, function (mongoerr) {
...
Wallet.prototype.update = function (callback) {
  ...
  return async.waterfall([
    ...
    self.setWalletToUpdated(err, result, callback).bind(self)
  });
};
